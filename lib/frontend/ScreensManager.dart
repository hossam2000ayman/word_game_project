...
import 'package:word_game_project/backend/loading/Loader.dart';
import 'package:word_game_project/frontend/common/ScreenSize.dart';
import 'package:word_game_project/frontend/screens/ScreenState.dart';
import 'package:word_game_project/frontend/screens/loading/LoadingScreen.dart';
import 'package:word_game_project/frontend/screens/menu/MenuScreen.dart';
...
class ScreensManager extends Game with TapDetector {
  ...
  void setScreenState(ScreenState state) {
    switch (state) {
      case ScreenState.LoadingScreen:
        _loadingScreen = LoadingScreen(_loader) as BaseScreen;
        _loadingScreen.resize();
        break;
      case ScreenState.MenuScreen:
        _menuScreen = MenuScreen() as BaseScreen;
        _menuScreen.resize();
        break;
      default:
        break;
